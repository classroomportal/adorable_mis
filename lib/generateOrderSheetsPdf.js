...
export async function generateOrderSheetsPdf({ forDate, locked, restaurants, allTotals, studentCount }) {
  ...
  const status = locked ? 'Final - orders locked 11pm Friday' : 'PROVISIONAL - ordering still open';
